...
export default function Navbar() {
  ...
  return (
    <nav className="navbar fixed top-5 left-1/2 transform -translate-x-1/2 w-[calc(100%-40px)] max-w-[1200px] bg-white/60 backdrop-blur-sm rounded-3xl shadow-lg z-50 px-8 py-4 transition-all duration-300">
