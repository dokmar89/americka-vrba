    ...
    return (
      <div className="bg-green-100 p-3 rounded-lg border-2 border-green-500 shadow-lg">
        ...
        <div className="flex justify-center items-center gap-4 mt-2">
          ...
          <span className="text-3xl font-extrabold text-green-600">799 Kč</span>
        </div>
    ...
    <div className="relative inline-block">
      ...
      <div className="flex flex-col items-center">
        <div className="flex items-baseline gap-3">
          ...
          <span className="text-2xl font-bold text-green-600">799 Kč</span>
        </div>
        <div className="text-xs text-center font-medium text-gray-600 mt-1">
          Ušetříte 91 Kč při nákupu nyní
        </div>
      </div>
    </div>
  )
